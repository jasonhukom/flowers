(function () {
  ...
  function initBouquetBuilder() {
    ...
    var wrapToggle = document.getElementById('builderWrapToggle');
    ...
    function refreshHint() {
      var hasContent = !!wrapEl || canvas.querySelector('.builder-flower');
      canvas.classList.toggle('has-flowers', !!hasContent);
    }
    ...
    function toggleWrap() {
      if (wrapEl) {
        wrapEl.remove();
        wrapEl = null;
        if (wrapToggle) wrapToggle.setAttribute('aria-pressed', 'false');
        refreshHint();
        return;
      }
      wrapEl = document.createElement('img');
      wrapEl.className = 'builder-wrap';
      wrapEl.src = 'assets/bouquet-wrap.png';
      wrapEl.alt = '';
      wrapEl.draggable = false;
      canvas.insertBefore(wrapEl, canvas.firstChild);
      if (wrapToggle) wrapToggle.setAttribute('aria-pressed', 'true');
      refreshHint();
    }
    ...
    picker.addEventListener('click', function (e) {
      ...
      if (btn === wrapToggle) { toggleWrap(); return; }
